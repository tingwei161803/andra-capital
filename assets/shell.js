/* =========================================================================
   ...
   Language does not persist: it belongs to the URL — English at the root,
   Chinese under /zh-Hant/ — so every page shows the language its address
    ...
    appbar.innerHTML =
      '<div class="appbar__inner">' +
        '<a class="brand" href="index.html">' +
          '<span class="brand__logo brand__logo--text" aria-hidden="true">AC</span>' +
